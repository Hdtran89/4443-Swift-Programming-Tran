...
//        view.subviews.map({ $0.removeFromSuperview() })
    ...
    func reorderColors(){
       ...
       // println(labelContainer)
        println(newOrder)
        for view in self.view.subviews {
            view.removeFromSuperview()
        }
        timer = NSTimer.scheduledTimerWithTimeInterval(0.10, target: self, selector: "addColor", userInfo: newOrder, repeats: true);
...
//        }
        ...
        //reverseLabel(newOrder)
      //  var temp = createLabel()
